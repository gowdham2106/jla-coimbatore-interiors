...
const AboutSection = () => {
  return (
    <section id="about" className="py-12 md:py-20 bg-luxury-cream">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              <h3 className="text-xl md:text-2xl font-semibold text-luxury-brown">
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6 mt-6 md:mt-8">
                <div className="text-center p-3 md:p-4 bg-white rounded-lg shadow-md">
                  <div className="text-xl md:text-2xl font-bold text-luxury-gold">15+</div>
                  <div className="text-xs md:text-sm text-gray-600">Years of Excellence</div>
                </div>
                <div className="text-center p-3 md:p-4 bg-white rounded-lg shadow-md">
                  <div className="text-xl md:text-2xl font-bold text-luxury-gold">500+</div>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
                <h4 className="text-lg md:text-xl font-semibold text-luxury-brown mb-3 md:mb-4">Our Commitment</h4>
                <ul className="space-y-2 md:space-y-3">
                  <li className="flex items-start">
                    <span className="text-luxury-gold mr-2">✓</span>
                    <span className="text-sm md:text-base text-gray-700">Premium quality materials and finishes</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-luxury-gold mr-2">✓</span>
                    <span className="text-sm md:text-base text-gray-700">Expert craftsmanship and installation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-luxury-gold mr-2">✓</span>
                    <span className="text-sm md:text-base text-gray-700">Timely project completion</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-luxury-gold mr-2">✓</span>
                    <span className="text-sm md:text-base text-gray-700">Competitive pricing with transparency</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-luxury-gold mr-2">✓</span>
                    <span className="text-sm md:text-base text-gray-700">Comprehensive after-sales support</span>
                  </li>
                </ul>
              </div>

              <div className="bg-luxury-brown text-white p-4 md:p-6 rounded-lg">
                <h4 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Why Choose Us?</h4>
                <p className="text-sm md:text-base text-luxury-cream">
